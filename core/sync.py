...
async def sync_ips_to_github(
    *,
    ...
    """
    if not token:
        raise GitHubSyncError("缺少 GitHub token，请传入 token")
    ...
    async with httpx.AsyncClient(timeout=timeout, follow_redirects=True) as client:
        ...
        logger.info("开始同步 GitHub 文件: {}/{}:{} ({})", owner, repo, remote_path, action)
    ...
    logger.info("GitHub 文件同步完成: {}/{}:{}", owner, repo, remote_path)
